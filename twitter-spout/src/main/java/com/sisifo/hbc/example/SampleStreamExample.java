...
package com.sisifo.hbc.example;

import com.google.common.collect.Lists;
import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import com.sisifo.tweet.Tweet;
import com.sisifo.tweet.TweetInstanceCreator;
import com.sisifo.tweet.utils.TweetFileWriter;
...
public class SampleStreamExample {
  ...
  public static void run(String consumerKey, String consumerSecret, String token, String secret) throws InterruptedException {
	...
	endpoint.languages(Lists.newArrayList("es"));
	endpoint.trackTerms(Lists.newArrayList("podemos"));
